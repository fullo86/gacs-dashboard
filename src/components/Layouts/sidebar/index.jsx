...
export function Sidebar() {
  ...
  useEffect(() => {
    // Keep collapsible open if subpage is active
    ...
    <>
      ...
      >
        <div className="flex h-full flex-col py-10 pl-[25px] pr-[7px]">
          ...
          {/* Navigation */}
          <div className="custom-scrollbar mt-6 flex-1 overflow-y-auto min-[850px]:mt-10 pr-3">
                          ...
                          (() => {
                            ...
                            return (
                              ...
                              <MenuItem
                                ...
                                href={item.action ? undefined : href}
                                onClick={item.action}
                                isActive={pathname === href}
                              >
                                <item.icon
